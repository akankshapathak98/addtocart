          ...
          <div class="cart-view-area">
            <div class="cart-view-table">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      ?>
                        <form method="post" action="">
                          <tr>
                            <td><a data-action="remove" data-productid="<?php echo $_SESSION["cart_item"][$key]["product_id"]; ?>" class="remove" href="#">
                            ...
                            <td><input class="aa-cart-quantity quantity" name="quantity[]" type="number" value="<?php echo  $_SESSION["cart_item"][$key]["quantity"]; ?>"></td>
              ...
              <div class="cart-view-total">
                ...
                <a href="#" class="aa-cart-view-btn checkout" data-checkout="checkout" name="checkout" data-totalpricecart="<?php echo number_format($total_price, 2); ?>">Proced to Checkout</a>
              </div>
