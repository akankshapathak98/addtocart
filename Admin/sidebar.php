<div id="sidebar">
	<div id="sidebar-wrapper">
		...
		$productmenu = array('products.php', 'categories.php', 'tags.php', 'addproducts.php');
		$usermenu = array('addusers.php', 'manageuser.php');
		$ordermenue = array('maageorder.php');
		$settingmenu = array('generalsetting.php');
		?>
		...
		<ul id="main-nav">
			...
			<li>
				...
				<ul>
					<li><a <?php if ($filename == 'addusers.php') : ?>class="current" <?php endif; ?> href="addusers.php">Add User</a></li>
					<li><a <?php if ($filename == 'manageuser.php') : ?>class="current" <?php endif; ?> href="manageuser.php">Manage Users</a></li>
				</ul>
			</li>

			<li>
				<a href="#" class="nav-top-item  <?php if (in_array($filename, $ordermenue)) : ?>current<?php endif; ?>">
					Orders
				</a>
				<ul>
					<li><a <?php if ($filename == 'maageorder.php') : ?>class="current" <?php endif; ?> href="maageorder.php">Manage Orders</a></li>
				</ul>
			</li>
			...
			<li>
				...
				<ul>
					<li><a <?php if ($filename == 'generalsetting.php') : ?>class="current" <?php endif; ?> href="generalsetting.php">General</a></li>
				</ul>
			</li>
